...
export default function FindRecordPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      {/* Header Section */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">Find Records</h1>
        <p className="text-gray-600">Search and manage records across different areas</p>
      </div>
      ...
      {selectedArea && !searchQuery && (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-500 mt-1">{persons.length} record(s) total</p>
          </div>
